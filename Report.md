...
Stage 4A, Stage 4B1–4B4, Stage 4C, Stage 5A, and Stage 5B are complete. v0.7.0 was published as a
GitHub prerelease for limited public testing on 2026-08-01. It adds restored historical schema-1.0
read compatibility, a result-browser `ReportError` fix, fail-fast Windows filesystem-error
