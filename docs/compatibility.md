...
The current supported compatibility contract for Membrane Visual QC, as of the `0.7.x`
development line (active version `0.7.0.dev0`). This is a statement of what is actually verified
