...
| v1.0.0 | 1.0-1.5 | 1.1, 1.2, 1.3, 1.4, 1.5 |
...
| v0.8.0-v1.0.0 | Unchanged, full support |
...
| v0.9.0 | v1.0.0rc1 / v1.0.0 | **Verified** -- clean replacement, installed-ZIP isolation, stale-module safety, retained contract compatibility, exact frozen-artifact upgrade, and rollback passed automated and owner-observed gates (`docs/releases/1.0.0rc1_manual_acceptance.md`, `docs/releases/1.0.0_manual_acceptance.md`) |

## Cache format support by release

| Release | Cache format |
|---|---|
| v0.5.0-v1.0.0 | `cache-v1`, unchanged byte-for-byte since introduction. No migration is needed across the verified clean-replacement paths because none exists to do. |
