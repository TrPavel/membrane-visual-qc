...
- `nonstandard_heteroatom_proximity`: other non-polymer evidence within the applicable configured
  proximity threshold, without inferred donor/acceptor chemistry.
...
Schema 1.2 will serialize all thresholds, atom-role policy version, category availability,
